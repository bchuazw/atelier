...
export default class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    ...
    return (
      <div className="flex items-center justify-center w-full h-full p-8 bg-stone-50">
        <div className="max-w-lg bg-white border border-rose-300/60 rounded-xl p-6 shadow-2xl">
          ...
          <details className="text-[11px] text-zinc-500 font-mono mb-4 max-h-56 overflow-auto">
            <summary className="cursor-pointer text-zinc-500 mb-1">Stack trace</summary>
